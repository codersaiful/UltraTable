...
function ultratable_admin_enqueue_scripts( $hook_suffix ) {
    wp_enqueue_style( $hook_suffix, ULTRATABLE_BASE_URL . 'assets/css/admin-common.css', array(), '1.0.0', 'all' );
    wp_enqueue_style( $hook_suffix, ULTRATABLE_BASE_URL . 'assets/css/admin-style.css', array(), '1.0.0', 'all' );
    wp_enqueue_script( $hook_suffix, ULTRATABLE_BASE_URL . 'assets/js/admin-script.js', array( 'jquery' ), '1.0.0', true );
}
